...
function checkout() {
  ...
  if (paymentMethod === 'tunai') {
    ...
    if (bayar < total) {
      ...
      document.getElementById('uang-bayar').style.outline = '2px solid var(--red)';
      setTimeout(() => { document.getElementById('uang-bayar').style.outline = ''; }, 2000);
      return;
    }
  }
